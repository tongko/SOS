...
namespace SOS.Common
{
	internal class HookInjector
	{
		...
		public static void InjectProcess(ProcessStartInfo targetProcess, string dllPath)
		{
			...
			IntPtr allocMemAddress = VirtualAllocEx(procHandle, IntPtr.Zero, (uint)((dllName.Length + 1) * Marshal.SizeOf(typeof(char))),
